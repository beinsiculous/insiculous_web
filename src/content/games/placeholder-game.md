...
<!-- PLACEHOLDER: longer description goes here — what the game is, how it
plays, what makes it interesting. Plain markdown. -->

This is placeholder body text for a game entry. Replace it with a real
description.
