...
// Pure: no DOM, no fetch, no storage — the same list drives the site's scripts/sync-fortknight.mjs,
// the /profile/ page (downloads), the two assistant pages (the guide rows and prompts), tests, and (later) native clients. Contract: docs/assistant-workspace.md.
